...
// 虐待の連絡先に**担当のケアマネジャーを入れる。**
// ケアマネジャー（居宅介護支援事業所の職員）は高齢者虐待防止法の
// 「養介護施設従事者等」に含まれ、**市町村へ通報する義務がある。**
// さらに同法は、**守秘義務の規定は通報を妨げるものと解釈してはならない**とし、
// 通報を理由とする不利益な取扱いも禁じている。
// → **いちばん話しやすい相手に言えば、市町村に上がる。**
// 市区町村を落とさないのは、**その事業所自身が関わる場合**があるため。
export const EMERGENCY_MESSAGE =
  "緊急の可能性があります。読みものではなく、こちらへご連絡ください。\n" +
  "・命に関わるとき → 119\n" +
  "・虐待のご相談 → 担当のケアマネジャー／お住まいの市区町村・地域包括支援センター\n" +
  "　（ケアマネジャーには市町村へ通報する義務があります）";
export const MEDICAL_MESSAGE =
  "この判断は主治医・訪問看護師にご相談ください。読みものではお答えできない内容です。";
// ⚠️ **出口はケアマネジャーが先。**
// 要介護認定を受けてサービスを使っている人には**担当のケアマネジャーがいる。**
// そこへ地域包括支援センターだけを案内すると、遠回りになる。
// 記事の中でも一貫して「ケアマネジャーに伝える」と書いているのに、
// 出口だけがずれていた（2026-08-27、本番投入後にオーナーの指摘で判明）。
// 地域包括支援センターは、**まだケアマネジャーがいない人**の入口として残す。
export const NONE_MESSAGE =
  "近い読みものが見つかりませんでした。担当のケアマネジャーにご相談ください。" +
  "まだ決まっていない場合は、お住まいの地域包括支援センターが最初の窓口になります。";
